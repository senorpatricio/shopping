            ...
            LinkTypeComponent = (function () {
                ...
                LinkTypeComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [menu_component_1.MenuComponent, router_1.ROUTER_DIRECTIVES, common_1.NgClass, quantity_component_1.QuantityCounter, accordion_1.Accordion, enrollment_component_1.EnrollmentComponent],
                        inputs: ['isDisabled'],
