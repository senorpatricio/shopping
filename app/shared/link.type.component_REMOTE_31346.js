System.register(['angular2/core', 'angular2/common', '../shared/menu.component', '../products/product-filter.pipe', '../products/product.service', '../shared/smart.link.component', 'angular2/router', './accordion', '../products/quantity.component', '../shared/menu.service', '../shared/linkBuild.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, common_1, menu_component_1, product_filter_pipe_1, product_service_1, smart_link_component_1, router_1, accordion_1, quantity_component_1, menu_service_1, linkBuild_service_1;
    ...
    return {
        ...
        execute: function() {
            LinkTypeComponent = (function () {
                ...
                function LinkTypeComponent(_productService, quantity, _menuService, builder) {
                    this._productService = _productService;
                    this.quantity = quantity;
                    this._menuService = _menuService;
                    this.builder = builder;
                    this.linkType = ['Smart Link Type', 'Retail Customer', 'Preferred Customer', 'Enrollment'];
                    //@Input() link = new LinkBuildService();
                ...
                LinkTypeComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [menu_component_1.MenuComponent, router_1.ROUTER_DIRECTIVES, common_1.NgClass, quantity_component_1.QuantityCounter, accordion_1.Accordion, accordion_1.AccordionGroup],
                        inputs: ['isDisabled'],
                        outputs: ['checkboxChanged', 'showProducts', 'item', 'quantityValue'],
                        providers: [quantity_component_1.QuantityCounter, menu_component_1.MenuComponent, menu_service_1.MenuService]
                    }), 
